...
class PlanEditViewTest extends GuiTestBase {
	...
	/**
	 * Helper method that verifies the add branch method initializes the correct
	 * nodes.
	 */
	...
	private void checkPage(String name, String content) {
		verifyThat(nameFieldID, (TextField textfield) -> { return textfield.getText().equals(name); });
		verifyThat(dataFieldID, (TextField textfield) -> { return textfield.getText().equals(content); });
	}
	...
	private void checkPage(String name, String content, String year) {
		verifyThat(yearFieldID, (TextField textfield) -> { return textfield.getText().equals(year); });
